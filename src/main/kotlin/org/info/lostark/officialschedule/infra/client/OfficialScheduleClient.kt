...
import org.info.lostark.officialschedule.infra.dto.ChallengeGuardianRaids
...
interface OfficialScheduleClient {
    ...
    @GetExchange("https://developer-lostark.game.onstove.com/gamecontents/challenge-guardian-raids")
    fun fetchRootGuardianRaids(@RequestHeader(name = "authorization") accessToken: String): ChallengeGuardianRaids
}