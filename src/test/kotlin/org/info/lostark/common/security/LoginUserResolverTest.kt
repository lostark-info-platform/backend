...
import org.info.lostark.user.query.UserQueryService
...
class LoginUserResolverTest : StringSpec({
    ...
    val loginUserResolver = LoginUserResolver(jwtTokenProvider, userQueryService)
    ...
    "요청의 Authorization Header로 유저 정보를 반환한다" {
        ...
        every { userQueryService.getByEmail("user@email.com") } returns createUser()
