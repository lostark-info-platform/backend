...
class OAuth2ServiceTest : BehaviorSpec({
    ...
    val oAuth2Service =
        OAuth2Service(oAuth2Resolver, oAuth2UserRepository, userRepository, jwtTokenProvider, refreshTokenService)
    Given("이미 OAuth2User가 저장되어 있는 경우") {
        ...
        When("로그인 요청하면") {
            val actual = oAuth2Service.login("kakao", "access_token")
